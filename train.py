...
if __name__ == '__main__':
    ...
    # Set DDP variables (Set Environment Variables)
    opt.total_batch_size = opt.batch_size
    opt.world_size = int(os.environ['WORLD_SIZE']) if 'WORLD_SIZE' in os.environ else 1 # number of all process
    opt.global_rank = int(os.environ['RANK']) if 'RANK' in os.environ else -1 # priority of each process
